            ...
            <Card className="sticky top-24 shadow-modal">
              <CardContent className="p-6">
                <div className="flex items-baseline space-x-2 mb-6">
                  <span className="text-2xl font-semibold">kr {dinner.price}</span>
                ...
                <div className="space-y-3 mb-6 text-sm">
                  <div className="flex justify-between">
                    <span>
                      kr {dinner.price} x {selectedGuests} guests
                    </span>
                    <span>kr {dinner.price * selectedGuests}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Service fee</span>
                    <span>kr {Math.round(dinner.price * selectedGuests * 0.20)}</span>
                  </div>
                  <Separator />
                  <div className="flex justify-between font-semibold">
                    <span>Total</span>
                    <span>kr {Math.round(dinner.price * selectedGuests * 1.20)}</span>
                  </div>
                </div>
