  ...
  const features = [
    {
      ...
      desc: 'Identity verified with Icelandic eID (Rafræn skilríki).',
      color: 'text-blue-500',
    ...
    },
    {
      ...
      desc: 'PCI-DSS card payments processed by Paystrax.',
    ...
    },
    {
      icon: Headphones,
      title: 'Email Support',
      desc: 'Reach us at info@datthome.com — we reply within one business day.',
