          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <article>
              <Card className="text-center h-full">
                ...
                <CardContent>
                  <CardDescription>
                    Join your host for an authentic dining experience. Share stories, try new
                    flavors, and make lasting memories.
                  </CardDescription>
                </CardContent>
              </Card>
            </article>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <article>
              <Card className="text-center h-full">
                ...
                <CardContent>
                  <CardDescription>
                    Create your host profile and tell us about your culinary skills, specialties,
                    and dining style.
                  </CardDescription>
                </CardContent>
              </Card>
